...
import { Code, Zap, Users, ArrowRight, Waves, ArrowUpRight, Plug } from "lucide-react";
...
<section className="relative py-20 bg-brightstar-primary overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    >
      ...
      >
        At Brightstar, we're not just another consultancy—we're the missing link in your digital transformation. 
        <span className="font-semibold text-white"> Think of us as your on-demand tech arm</span>, 
        seamlessly integrating into your organization to strategize, consult, and build the technology that 
        propels your business forward. Whether you're a startup on the brink of disruption or an 
        established enterprise seeking to innovate, we turn bold ideas into dynamic digital solutions.
      </motion.p>
